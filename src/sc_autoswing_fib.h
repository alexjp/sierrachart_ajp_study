#ifndef SC_AUTOSWING_FIB_H
#define SC_AUTOSWING_FIB_H
...
int const _AUTO_SWING_I_EXT_TOP = 18;
int const _AUTO_SWING_I_EXT_BOTTOM = 19;
int const _AUTO_SWING_I_EXT_MIDDLE = 20;
int const _AUTO_SWING_I_USE_EXT_ATR = 21;


int const _AUTO_SWING_I_BUTTON_ON = 30;
int const _AUTO_SWING_I_BUTTON_OFF = 31;
int const _AUTO_SWING_I_ALERT = 32;
